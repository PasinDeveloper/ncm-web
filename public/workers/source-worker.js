// Import crypto-js modules locally
importScripts("/crypto-js/core.min.js");
importScripts("/crypto-js/cipher-core.min.js");
importScripts("/crypto-js/aes.min.js");
importScripts("/crypto-js/mode-ecb.min.js");
importScripts("/crypto-js/enc-base64.min.js");
importScripts("/crypto-js/enc-utf8.min.js");
importScripts("/crypto-js/lib-typedarrays.min.js");
...
self.onmessage = (e) => {
  ...
  for (const data of e.data) {
    ...
    const transferableBuffer = audioData.slice().buffer;
    ...
    self.postMessage(
      {
        ...
        payload: {
          meta: musicMeta,
          audioBuffer: transferableBuffer,
          mimeType: audio_mime_type[musicMeta.format],
          format: musicMeta.format,
        },
      },
      [transferableBuffer]
    );
    console.log("Worker posted:", { id: data.id, meta: musicMeta });
  }
};
